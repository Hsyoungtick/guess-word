...
export default function Home() {
  ...
  async function sendGuess(event: FormEvent) {
    ...
    if ([...word].length > 8) { setActionError('猜词最多 8 个字，请缩短后再发射'); return }
    setGuess('')
